...
export default function PublicPlayerRegistration({
  ...
  return (
    <div className="bg-[var(--background)] text-[var(--foreground)] flex flex-col items-center justify-center p-5 md:p-12 transition-colors duration-300 max-w-2xl mx-auto">
      {step === 1 && (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              ...
              <div>
                ...
                >
                  ...
                  <option className="bg-[var(--surface-1)]">All-Rounder</option>
