            ...
            <div key={d.id} className="relative group">
              ...
              {i === 0 && isAuthorized && (
                <button
                  ...
                  className="absolute -top-1 -right-1 bg-red-600 text-white rounded-full w-5 h-5 text-[13px] flex items-center justify-center border-2 border-[var(--surface-1)] shadow-lg hover:scale-110 transition-transform"
                >
                  ✕
                </button>
              )}
