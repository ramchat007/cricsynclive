...
export default function VoiceConfirmationToast({
  ...
  return (
    <div className="fixed bottom-24 left-1/2 -translate-x-1/2 z-[100] w-[90%] max-w-sm animate-in slide-in-from-bottom-10 fade-in duration-300">
      <div className="bg-[var(--surface-1)] border border-[var(--border-1)] rounded-xl shadow-2xl overflow-hidden flex flex-col">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[13px] font-black uppercase tracking-widest text-[var(--text-muted)]">
                Voice Command
              </p>
