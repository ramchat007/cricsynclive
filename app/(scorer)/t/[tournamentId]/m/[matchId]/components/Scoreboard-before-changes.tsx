    ...
    <div className="flex flex-col gap-2 sm:gap-4 animate-in fade-in">
      ...
      {isCompleted ? (
        <div className="bg-yellow-500/10 border border-yellow-500/20 p-2 sm:p-4 rounded-xl text-center shadow-inner">
          <p className="text-[13px] font-black text-yellow-600 uppercase tracking-widest mb-0.5">
            Match Result
          </p>
      ...
      >
        ...
        {isSecondInnings && (
          <div className="bg-[var(--surface-2)] p-3 sm:p-6 rounded-xl sm:rounded-xl border border-[var(--border-1)] shadow-inner flex flex-row md:flex-col justify-between md:justify-center items-center text-left md:text-center md:opacity-80 relative gap-2 md:gap-0">
        ...
        {/* ACTIVE / LIVE SCORE */}
        <div
          className={`${!isSecondInnings ? "md:col-span-2" : ""} bg-[var(--surface-1)] p-3 sm:p-6 rounded-xl sm:rounded-xl border ${isCompleted ? "border-[var(--border-1)]" : "border-[var(--accent)]/50 shadow-[0_0_15px_rgba(var(--accent-rgb),0.1)]"} flex flex-col justify-center items-center text-center relative overflow-hidden`}
        >
          ...
          <div className="mt-3 sm:mt-4 flex flex-wrap items-center justify-center gap-1.5 relative z-10 md:hidden">
            <div className="flex items-center text-[13px] font-bold text-[var(--text-muted)] bg-[var(--surface-2)] px-2 py-1 rounded-lg border border-[var(--border-1)] uppercase tracking-widest">
              Overs:{" "}
            ...
            <div className="text-[13px] font-bold text-[var(--text-muted)] bg-[var(--surface-2)] px-2 py-1 rounded-lg border border-[var(--border-1)] uppercase tracking-widest">
              CRR:{" "}
                ...
                <div className="flex gap-1 sm:gap-1.5 overflow-x-auto hide-scrollbar max-w-full sm:max-w-md px-1 pb-1">
                  {tapeDeliveries.map((d: any, idx: number) => {
                    ...
                    return (
                      <span
                        key={d.id || idx}
                        className={`flex items-center justify-center min-w-[26px] h-6 sm:min-w-[32px] sm:h-8 px-1 rounded-full text-[13px] sm:text-xs font-black shadow-sm shrink-0 ${
                          isWicket
        ...
        {!isSecondInnings && (
          <div className="hidden md:flex flex-col gap-4">
            <div className="bg-[var(--surface-1)] p-6 rounded-xl border border-[var(--border-1)] shadow-sm flex flex-col items-center justify-center flex-1 transition-colors">
      ...
      <div className="text-center text-[13px] sm:text-xs font-bold text-[var(--text-muted)] mt-1 sm:mt-0">
        Extras:{" "}
