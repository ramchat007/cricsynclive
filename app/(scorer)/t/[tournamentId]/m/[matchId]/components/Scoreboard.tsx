  ...
  const PerformersList = ({ title, batters, bowlers }: any) => (
    <div className="bg-[var(--surface-2)] p-4 sm:p-5 rounded-[1.5rem] border border-[var(--border-1)] flex-1">
      ...
      <div className="space-y-4">
        ...
        {batters.length > 0 && (
          <div>
            <div className="flex justify-between text-[9px] sm:text-[12px] uppercase font-black text-[var(--text-muted)] tracking-widest mb-2 px-1">
              <span>Batter</span>
    ...
    <div className="flex flex-col gap-4 animate-in fade-in">
      ...
      <div className="bg-[var(--surface-1)] p-3 sm:p-4 rounded-[1.5rem] sm:rounded-2xl border border-[var(--border-1)] shadow-sm flex flex-col sm:flex-row items-center justify-between text-center sm:text-left gap-3 transition-colors">
        <div className="inline-block bg-[var(--surface-2)] px-3 py-1.5 rounded-lg border border-[var(--border-1)]">
          <p className="text-[12px] sm:text-xs font-black text-[var(--text-muted)] uppercase tracking-widest">
      ...
      {isCompleted ? (
        <div className="bg-yellow-500/10 border border-yellow-500/20 p-4 rounded-[1.5rem] text-center shadow-inner">
          <p className="text-[12px] font-black text-yellow-600 uppercase tracking-widest mb-1">
            Match Result
          </p>
        ...
        <div className="bg-[var(--surface-1)] border border-[var(--border-1)] rounded-[1.5rem] p-4 flex justify-between items-center shadow-sm">
          <div>
            <p className="text-[12px] font-black text-red-500 uppercase tracking-widest bg-red-500/10 px-2 py-1 rounded inline-block mb-1">
              Target: {targetScore}
            </p>
          ...
          <div className="text-right">
            <p className="text-[12px] font-black text-[var(--text-muted)] uppercase tracking-widest mb-1">
              Required RR
            </p>
      ...
      >
        ...
        {isSecondInnings && (
          <div className="bg-[var(--surface-2)] p-4 sm:p-6 rounded-[2rem] border border-[var(--border-1)] shadow-inner flex flex-col justify-center items-center text-center opacity-70 hover:opacity-100 transition-opacity relative">
            <p className="text-[12px] sm:text-xs font-black text-[var(--text-muted)] uppercase tracking-widest mb-2">
            ...
            <div className="mt-3 flex items-center justify-center gap-3">
              <div className="text-[12px] font-bold text-[var(--text-muted)] bg-[var(--surface-1)] px-3 py-1.5 rounded-lg border border-[var(--border-1)] uppercase tracking-widest">
                Overs:{" "}
        ...
        >
          ...
          <p className="text-[12px] sm:text-xs font-black text-[var(--text-muted)] uppercase tracking-widest mb-2 relative z-10">
          ...
          <div className="mt-4 flex items-center justify-center gap-3 relative z-10">
            <div className="text-[12px] font-bold text-[var(--text-muted)] bg-[var(--surface-2)] px-3 py-1.5 rounded-lg border border-[var(--border-1)] uppercase tracking-widest">
              Overs:{" "}
        ...
        {!isSecondInnings && (
          <div className="grid grid-cols-2 md:grid-cols-1 gap-4">
            <div className="bg-[var(--surface-1)] p-3 sm:p-6 rounded-[2rem] sm:rounded-3xl border border-[var(--border-1)] shadow-sm flex flex-col items-center justify-center flex-1 transition-colors">
              <p className="text-[12px] sm:text-sm font-black text-[var(--text-muted)] uppercase tracking-widest mb-1 sm:mb-2">
                Overs
              </p>
              <button
      ...
      {/* EXTRAS FOOTER */}
      <div className="text-center text-[12px] sm:text-xs font-bold text-[var(--text-muted)] mt-2">
        Extras:{" "}
