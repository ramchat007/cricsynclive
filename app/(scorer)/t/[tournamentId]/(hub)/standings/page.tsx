      ...
      <div className="max-w-5xl mx-auto animate-in fade-in">
        ...
        <div className="bg-[var(--surface-1)] rounded-xl border border-[var(--border-1)] shadow-sm overflow-hidden transition-colors">
          ...
          <div className="block md:hidden flex-col divide-y divide-[var(--border-1)]">
            ...
            <div className="bg-[var(--surface-2)] text-[var(--text-muted)] px-4 py-3 text-[13px] uppercase font-black tracking-widest flex justify-between">
              ...
              >
                ...
                <div className="flex items-center justify-between pl-[3.25rem] text-xs">
                  <div className="flex gap-3 font-bold text-[var(--text-muted)]">
                    ...
                    <span>
                      W: <span className="text-emerald-500">{team.won}</span>
                    </span>
                    <span>
                      L: <span className="text-red-500">{team.lost}</span>
                    </span>
                    {team.tied > 0 && (
                      <span>
                        T: <span>{team.tied}</span>
                      </span>
                    )}
                  </div>
                  <div
                    className={`font-black ${team.nrr >= 0 ? "text-emerald-500" : "text-red-500"}`}
                  >
                    {team.nrr > 0 ? "+" : ""}
                    {team.nrr.toFixed(3)}
                  </div>
